...
class TestLiturgicalcalendarAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LiturgicalcalendarAPIClient(self.api_key)

    @patch('apiverve_liturgicalcalendar.apiClient.requests.get')
